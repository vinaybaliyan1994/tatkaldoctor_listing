...
<h1 class="text-2xl font-bold text-slate-800 mb-1">Add Subscription</h1>
<p class="text-slate-500 text-sm mb-6">Assign a subscription plan to a client.</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="md:col-span-2">
            ...
            <textarea id="notes" name="notes" rows="3"
                      class="w-full px-4 py-2.5 rounded-xl border @error('notes') border-red-400 bg-red-50 @else border-slate-200 bg-slate-50 @enderror text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-400 transition resize-none">{{ old('notes') }}</textarea>
