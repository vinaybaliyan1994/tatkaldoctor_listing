...
<div class="mb-6 flex items-center gap-2 text-sm text-gray-500">
    ...
    <span class="text-gray-800 font-medium">Add Client</span>
</div>

<div class="max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-800 mb-1">Add API Client</h1>
    <p class="text-gray-500 text-sm mb-6">API Key and Secret Key are generated automatically. The secret key is shown only once after creation.</p>
