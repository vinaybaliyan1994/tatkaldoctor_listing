...
<div class="mb-6 flex items-center gap-2 text-sm text-gray-500">
    ...
    <span class="text-gray-800 font-medium">Add City</span>
</div>

<div class="max-w-lg">
    <h1 class="text-2xl font-bold text-gray-800 mb-1">Add City</h1>
    <p class="text-gray-500 text-sm mb-6">Select the country and enter the city name.</p>
