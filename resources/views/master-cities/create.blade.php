...
@section('title', 'Add City — TatkalDoctor Admin')
...
<div class="mb-6 flex items-center gap-2 text-sm text-slate-500">
    ...
    <span class="text-slate-800 font-medium">Add City</span>
</div>

<div class="max-w-lg">
    <h1 class="text-2xl font-bold text-slate-800 mb-1">Add City</h1>
    <p class="text-slate-500 text-sm mb-6">Select the country and enter the city name.</p>

    @include('partials.alerts')

    <div class="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
        <form method="POST" action="{{ route('master-cities.store') }}" class="space-y-5">
            @csrf
