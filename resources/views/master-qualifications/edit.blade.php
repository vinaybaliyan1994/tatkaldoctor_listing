...
<div class="mb-6 flex items-center gap-2 text-sm text-slate-500">
    ...
    <span class="text-slate-800 font-medium">Edit Qualification</span>
</div>

<div class="max-w-lg">
    <h1 class="text-2xl font-bold text-slate-800 mb-1">Edit Qualification</h1>
    <p class="text-slate-500 text-sm mb-6">Update the qualification acronym or status.</p>
