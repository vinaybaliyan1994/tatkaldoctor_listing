...
<div class="mb-6 flex items-center gap-2 text-sm text-slate-500">
    ...
    <span class="text-slate-800 font-medium">Add Listing</span>
</div>

<h1 class="text-2xl font-bold text-slate-800 mb-1">Add Doctor Listing</h1>
<p class="text-slate-500 text-sm mb-6">Fill in the doctor's profile details below.</p>
        ...
        <div>
            ...
            <textarea id="address" name="address" rows="2" maxlength="500"
                      ...
                      class="w-full px-4 py-2.5 rounded-xl border @error('address') border-red-400 bg-red-50 @else border-slate-200 bg-slate-50 @enderror
                             text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-400 transition resize-none">{{ old('address') }}</textarea>
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="4" maxlength="2000"
                      ...
                      class="w-full px-4 py-2.5 rounded-xl border @error('description') border-red-400 bg-red-50 @else border-slate-200 bg-slate-50 @enderror
                             text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-400 transition resize-y">{{ old('description') }}</textarea>
