...
<div class="mb-6 flex items-center gap-2 text-sm text-slate-500">
    ...
    <span class="text-slate-800 font-medium">Edit Service</span>
</div>

<div class="max-w-lg">
    <h1 class="text-2xl font-bold text-slate-800 mb-1">Edit Service</h1>
    <p class="text-slate-500 text-sm mb-6">Update the service name, category, or status.</p>
