...
<div class="mb-6 flex items-center gap-2 text-sm text-gray-500">
    ...
    <span class="text-gray-800 font-medium">Add Service</span>
</div>

<div class="max-w-lg">
    <h1 class="text-2xl font-bold text-gray-800 mb-1">Add Service</h1>
    <p class="text-gray-500 text-sm mb-6">Choose whether this is a main category or a sub-service of an existing one.</p>
