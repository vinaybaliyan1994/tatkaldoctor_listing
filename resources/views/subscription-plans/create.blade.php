...
<h1 class="text-2xl font-bold text-gray-800 mb-1">Create Subscription Plan</h1>
<p class="text-gray-500 text-sm mb-6">Add a new pricing tier for clients.</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1" for="slug">
                Slug <span class="text-gray-400 text-xs font-normal">(auto-generated if blank)</span>
            </label>
        ...
        <div class="md:col-span-2">
            ...
            <textarea id="description" name="description" rows="3"
                      class="w-full px-4 py-2.5 rounded-lg border @error('description') border-red-400 bg-red-50 @else border-gray-300 @enderror
                             text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition resize-none">{{ old('description') }}</textarea>
        ...
        <div class="md:col-span-2">
            ...
            <textarea id="features" name="features" rows="5" placeholder="Priority listing&#10;WhatsApp notifications&#10;API access"
                      class="w-full px-4 py-2.5 rounded-lg border @error('features') border-red-400 bg-red-50 @else border-gray-300 @enderror
                             text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition resize-y">{{ old('features', is_array(old('features')) ? implode("\n", old('features')) : '') }}</textarea>
