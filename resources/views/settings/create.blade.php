...
<h1 class="text-2xl font-bold text-gray-800 mb-1">Add Setting</h1>
<p class="text-gray-500 text-sm mb-6">Create a new global configuration key.</p>
        ...
        <div class="md:col-span-2">
            ...
            <textarea id="value" name="value" rows="4"
                      class="w-full px-4 py-2.5 rounded-lg border @error('value') border-red-400 bg-red-50 @else border-gray-300 @enderror
                             text-sm text-gray-900 font-mono focus:outline-none focus:ring-2 focus:ring-blue-500 transition resize-y">{{ old('value') }}</textarea>
