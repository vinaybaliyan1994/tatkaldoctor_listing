...
<#
.SYNOPSIS
    Backup doctor-listing: DB dump + uploads + logs (last 7 days).
    Output: C:\tatkaldoctor_backups\YYYY-MM-DD\doctor-listing\
#>

Set-StrictMode -Version Latest
$ErrorActionPreference = 'Stop'

$ProjectRoot = "C:\wamp64\www\doctor_listing"
$ProjectName = "doctor-listing"
$DbName      = "tatkaldoctor_listing"
$DbHost      = "127.0.0.1"
$DbPort      = "3306"
$DbUser      = "root"
$DbPassword  = ""
